  ...
  return (
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            ...
            <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Hotel Midas Regency is a distinguished team within the hospitality industry, renowned for its commitment to excellence and unwavering dedication to providing unparalleled guest experiences.</p>
        </div> 
        <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
            ...
            <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                    <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Manoj Deokar</a>
                    </h3>
                    <span class="text-gray-500 dark:text-gray-400">COOs</span>
